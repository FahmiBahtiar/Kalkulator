        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txt1.getText().toString().equals("hambaallah@gmail.com") && txt2.getText().toString().equals("hambaallah")) {
                    ...
                    editor.apply();
                    finish();
                } else if(txt1.getText().toString().equals("hambaallah@gmail.com") && !txt2.getText().toString().equals("hambaallah")){
                    tv4.setText("Password Salah.");
                } else if (!txt1.getText().toString().equals("hambaallah@gmail.com") && !txt2.getText().toString().equals("hambaallah")){
                    tv4.setText("Kombinasi Email Dan Password Salah.");
                }
